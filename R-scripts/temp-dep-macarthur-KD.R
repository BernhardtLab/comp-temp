#this is joey's function-- not using this anymore, because I want to have all parameters in the top matter, for easy manipulation within the analysis script. Nothing fixed in this script.
temp_dependences_MacArthurb <- function(T = 25,
									   r_EaN = 0.5, r_EaP = 0.5,
	...
	rN = arrhenius_function(Temp = T, E = r_EaN, b1 = 0.1)
	rP = arrhenius_function(Temp = T, E = r_EaP, b1 = 0.05)

	# resource carrying capacity
	KN = arrhenius_function(Temp = T, E = K_EaN, b1 = 2000)
	KP = arrhenius_function(Temp = T, E = K_EaP, b1 = 2000)
...
#here is my version of JB's temp_dependences_macarthur script, where all parameter appear in the top list
temp_dependences_MacArthurc <- function(T = T,
  ...
  # resource growth rates
  rN = arrhenius_function(Temp = T, E = r_EaN, b1 = r_N_b)
  rP = arrhenius_function(Temp = T, E = r_EaP, b1 = r_P_b)
  
  # resource carrying capacity
  KN = arrhenius_function(Temp = T, E = K_EaN, b1 = K_N_b)
  KP = arrhenius_function(Temp = T, E = K_EaP, b1 = K_P_b)
  ...
  m2 = arrhenius_function(Temp = T, E = m_Ea2, b1 = m2_b)
...
arrhenius_function_25 <- function(Temp, E, b1, ref_temp = 25) {
	k <- 8.62e-05 #Boltzmann's constant
	E <- E # 0.6 # activation energy (eV)
	T <- Temp+273.15 #range of temp in K
	Tc <- ref_temp+273.15 #reference temperature
...
# temp dependence macarthur ref temp  = 0 ---------------------------------
arrhenius_function_0 <- function(Temp, E, b1, ref_temp = 0) {
	k <- 8.62e-05 #Boltzmann's constant
	E <- E # 0.6 # activation energy (eV)
	T <- Temp+273.15 #range of temp in K
	Tc <- ref_temp+273.15 #reference temperature
...
temp_dependences_MacArthur_ref0 <- function(T = 0, #KD changed the arrhenius functions in here to arrhenius_function_0
											r_EaN = 0.5, r_EaP = 0.5, 
											c_Ea1N = 0.8, c_Ea1P = 0.8, 
											c_Ea2N = 0.8, c_Ea2P = 0.8, 
											K_EaN = -0.3, K_EaP = -0.3, 
	...
	# resource growth rates
	rN = arrhenius_function_0(Temp = T, E = r_EaN, b1 = 0.1) 
	rP = arrhenius_function_0(Temp = T, E = r_EaP, b1 = 0.05) 
	
	# resource carrying capacity
	KN = arrhenius_function_0(Temp = T, E = K_EaN, b1 = 2000) 
	KP = arrhenius_function_0(Temp = T, E = K_EaP, b1 = 2000) 
	
	# cij = per capita consumption of comsumer i on resource j
	c1N = arrhenius_function_0(Temp = T, E = c_Ea1N, b1 = C1N_b)
	c1P = arrhenius_function_0(Temp = T, E = c_Ea1P, b1 = c1P_b) ## species 1 consumes more P than N
	c2N = arrhenius_function_0(Temp = T, E = c_Ea2N, b1 = c2N_b) ## species 2 consumes more N than P
	c2P = arrhenius_function_0(Temp = T, E = c_Ea2P, b1 = c2P_b) 
	
	# vij = conversion factor that converts resource j into biomass of consumer i
	v1N = arrhenius_function_0(Temp = T, E = v_EaN, b1 = 0.2)
	v2N = arrhenius_function_0(Temp = T, E = v_EaN, b1 = 0.4) ## species 2 converts N more efficiently 
	v1P = arrhenius_function_0(Temp = T, E = v_EaP, b1 = 0.4) ## species 1 converts P more efficiently 
	v2P = arrhenius_function_0(Temp = T, E = v_EaP, b1 = 0.2)
	
	# mortality rates
	m1 = arrhenius_function_0(Temp = T, E = m_Ea1, b1 = 0.01)
	m2 = arrhenius_function_0(Temp = T, E = m_Ea2, b1 = 0.01)
