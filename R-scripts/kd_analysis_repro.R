#KD trying to reproduce JB's code from R-scripts/mac-parameter-fitting-ref25_zero_EAs_dec24.R

# author: Kaleigh Davis, Postdoc with JB at U of Guelph
# script DOB: 2/12/2025
# script requirements: this script sources functions from the R-scripts/temp_dependence_MacArthurb.R script, as well as a dataset of empirically derived parameters estimates, located at data/mac-means.csv
