...
c_var_plot <- 
  ...
  coord_cartesian(ylim = c(-0.52, 0.55), xlim = c(-0.022, 1.02)) +
  ...
  annotate("text", x = 0.75, y = 0.3, label = expression("Consumption \nrate," ~ italic(c)[italic(ik)]), size = 6)
...
r_var_plot <- 
  ...
  theme_cowplot(font_size = 20) + 
  theme(legend.position = "none") +
  annotate("text", x = 0.75, y = 0.3, label = expression("Resource \ngrowth rate," ~ italic(r)[italic(k)]), size = 6)
...
k_var_plot <- 
  ...
  theme_cowplot(font_size = 20) + 
  theme(legend.position = "none") +
  annotate("text", x = 0.75, y = 0.25, label = expression("Resource \ncarrying \ncapacity," ~ italic(K)[italic(k)]), size = 6)
...
v_var_plot <- 
  ...
  theme_cowplot(font_size = 20) + 
  theme(legend.position = "none") +
  annotate("text", x = 0.75, y = 0.3, label = expression("Conversion \nefficiency," ~ italic(v)[italic(k)]), size = 6)
...
m_var_plot <- 
  ...
  theme_cowplot(font_size = 20) + 
  theme(legend.position = "none") +
  annotate("text", x = 0.75, y = 0.3, label = expression("Consumer \nmortality rate," ~ italic(m)[italic(i)]), size = 6)

# rrc equal base growth plot ###
rrce_plots <- c_var_plot + r_var_plot + k_var_plot + v_var_plot + m_var_plot
# ggsave(plot = rrce_plots, filename = "figures/kd-figs/param_var_errce.pdf", width = 14, height = 10)
...
log_pom_rrce_all <-
  ...
  coord_cartesian(ylim = c(-0.52, 0.55), xlim = c(-0.022, 0.55)) +
  scale_y_continuous(breaks = c(-0.5, -0.25, 0, 0.25, 0.5, 0.75)) +
  ...
  annotate("text", x = 0.05, y = 0.3, label = "Species 2 wins", size = 5, fontface = 2) +
...
# ggsave(plot = startpoint1, filename = "figures/kd-figs/supp_startpoint_errce.pdf", height = 20, width = 26)
...
ggsave(plot = urrce_plots, filename = "figures/kd-figs/param_var_urrce.pdf", width = 14, height = 10)
...
ggsave(plot = startpoint2, filename = "figures/kd-figs/supp_startpoint_urrce.pdf", height = 20, width = 26)
