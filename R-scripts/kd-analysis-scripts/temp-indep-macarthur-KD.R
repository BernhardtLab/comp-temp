...
temp_indep_mac <- function(r_EaN = 0, r_EaP = 0, #activation energy growth rate N and P
  ...
  rN = arrhenius_tind(E = r_EaN, b1 = r_N_b)
  rP = arrhenius_tind(E = r_EaP, b1 = r_P_b)
  
  # resource carrying capacity
  KN = arrhenius_tind(E = K_EaN, b1 = K_N_b)
  KP = arrhenius_tind(E = K_EaP, b1 = K_P_b)
  
  # cij = per capita consumption of comsumer i on resource j
  c1N = arrhenius_tind(E = c_Ea1N, b1 = c1N_b)
  c1P = arrhenius_tind(E = c_Ea1P, b1 = c1P_b) ## species 1 consumes more P than N
  c2N = arrhenius_tind(E = c_Ea2N, b1 = c2N_b) ## species 2 consumes more N than P
  c2P = arrhenius_tind(E = c_Ea2P, b1 = c2P_b)
  
  # vij = conversion factor that converts resource j into biomass of consumer i
  v1N = arrhenius_tind(E = v_EaN, b1 = v1N_b)
  v2N = arrhenius_tind(E = v_EaN, b1 = v2N_b) ## species 2 converts N more efficiently
  v1P = arrhenius_tind(E = v_EaP, b1 = v1P_b) ## species 1 converts P more efficiently
  v2P = arrhenius_tind(E = v_EaP, b1 = v2P_b)
  
  # mortality rates
  m1 = arrhenius_tind(E = m_Ea1, b1 = m1_b)
  m2 = arrhenius_tind(E = m_Ea2, b1 = m2_b)
